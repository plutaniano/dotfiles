...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ReplaceWithRegister = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/ReplaceWithRegister",
  ...
  ["cmp-path"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  ["friendly-snippets"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "https://github.com/williamboman/mason-lspconfig.nvim"
  },
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["nvim-cmp"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/nvim-cmp",
  ...
  ["nvim-tree.lua"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/typescript.nvim",
    url = "https://github.com/jose-elias-alvarez/typescript.nvim"
  },
  ["vim-maximizer"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/vim-maximizer",
    url = "https://github.com/szw/vim-maximizer"
  },
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
